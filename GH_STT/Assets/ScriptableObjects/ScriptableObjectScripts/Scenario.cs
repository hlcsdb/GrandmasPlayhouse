...
public class Scenario : ScriptableObject
{
    ...
    public void Awake()
    {
        ...
        randSlots = new List<Vector2> { new Vector2(-400, 118), new Vector2(-400, 3), new Vector2(-400, -112), new Vector2(-400, -227), new Vector2(400, 118), new Vector2(400, 3), new Vector2(400, -112), new Vector2(400, -227) };
